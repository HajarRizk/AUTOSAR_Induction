 ...
 *  Di Li                       visldi        Vector Informatik GmbH
...
# define PDUR_SW_MAJOR_VERSION  13u  /**< Major version */
 ...
 *  \reentrant   FALSE
 *  \synchronous TRUE
 *  \note        In Multi Core UseCase: This function shall only be called ONCE and NOT for each core.
 *  \trace       SPEC-38464
 ********************************************************************************************************************/
