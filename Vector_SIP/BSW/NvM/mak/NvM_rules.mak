...
# 1.01.00   2007-08-24  Ck      Adapted to NvM
# 1.02.00   2008-08-27  Ck      Added Library Rules
...
NvM_FILES                = NvM$(BSW_SRC_DIR)\NvM.c NvM$(BSW_SRC_DIR)\NvM_Act.c NvM$(BSW_SRC_DIR)\NvM_Crc.c NvM$(BSW_SRC_DIR)\NvM_JobProc.c NvM$(BSW_SRC_DIR)\NvM_Qry.c NvM$(BSW_SRC_DIR)\NvM_Queue.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += NvM$(BSW_SRC_DIR)\NvM.c NvM$(BSW_SRC_DIR)\NvM_Act.c NvM$(BSW_SRC_DIR)\NvM_Crc.c NvM$(BSW_SRC_DIR)\NvM_JobProc.c NvM$(BSW_SRC_DIR)\NvM_Qry.c NvM$(BSW_SRC_DIR)\NvM_Queue.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
