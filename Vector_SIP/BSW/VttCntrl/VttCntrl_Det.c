...
STATIC void VTTCntrl_DetInitialization_FiM(void)
{
  ...
  CANoeAPI_DetSetError(11, 0x00, "FIM_E_NO_ERROR");
  CANoeAPI_DetSetError(11, 0x01, "FIM_E_UNINIT");
  CANoeAPI_DetSetError(11, 0x02, "FIM_E_FID_OUT_OF_RANGE");
  CANoeAPI_DetSetError(11, 0x03, "FIM_E_EVENTID_OUT_OF_RANGE");
  CANoeAPI_DetSetError(11, 0x04, "FIM_E_PARAM_POINTER");
  CANoeAPI_DetSetError(11, 0x05, "FIM_E_INIT_FAILED");
  CANoeAPI_DetSetError(11, 0x80, "FIM_E_PARAM_DATA");
}
