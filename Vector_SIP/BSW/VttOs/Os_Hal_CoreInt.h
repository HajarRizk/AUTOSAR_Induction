...
struct Os_Hal_CoreAsrConfigType_Tag
{
  ...
  CANoeTaskIdType NumberOfCANoeEmuTasks;
...
/*! \brief  Function typecast for a function with no arguments.
 */
typedef P2FUNC(void, OS_CODE, Os_Hal_CoreEntryFunc)( void );
 ...
 **********************************************************************************************************************/
/*! \brief          Get execution context of the current core.
 *  \details        This function is used to get the execution context of the given core.
 *
 *  \return         Pointer to the current context of the given core.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      FALSE
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE P2VAR(Os_Hal_ContextType, AUTOMATIC, AUTOMATIC), OS_CODE,
 ...
 **********************************************************************************************************************/
/*! \brief          Set execution context of the current core.
 *  \details        This function is used to set the execution context of the given core.
 *
 *  \param[in]      Context  Pointer to context which has to be set. Parameter must not be NULL.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      FALSE
 ...
 *  Os_Hal_ConsumeStack()
 **********************************************************************************************************************/
/*! \brief          Use the given stack.
 *  \details        The function is used to consume a stack in a given context.
 *
 *  \param[out]     Stack  Pointer to stack config which has to be set. Parameter must not be NULL.
 *
 *  \context        OS_INTERNAL
 ...
 *  \pre            -
 **********************************************************************************************************************/
FUNC(void, OS_CODE) Os_Hal_ConsumeStack
(
