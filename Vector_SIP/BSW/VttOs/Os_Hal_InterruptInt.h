...
{
  Os_Hal_IntLevelType InterruptLevel;
};
 ...
 *  \details        Performs the read-modify-write on global interrupts in a single function instead of a
 *                  call sequence for modification of the global interrupt flag.
 *
