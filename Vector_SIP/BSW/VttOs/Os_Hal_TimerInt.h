 ...
 *   \details   The define is used for calculation purpose in case the hardware timer bit width is larger then 32bit.
 */
 ...
 *  \details        The kernel uses this function during OS initialization to initialize hardware timers.
 ...
 *  \details        The kernel uses this function to implement the PIT ISR. It is used to clear the pending
 *                  timer interrupt flag. This function should reload the compare value, if the timer hardware
 *                  doesn't perform this automatically.
 *
 *  \param[in]      TimerConfig     Timer hardware configuration. Parameter must not be NULL.
 *
 ...
 *  \details        The kernel uses this function to detect job overload.
 *
 *  \param[in]      TimerConfig     Timer hardware configuration. Parameter must not be NULL.
 *
 ...
 *  \details        The kernel uses this function to implement the AUTOSAR counter interface in case of a
 *                  free running timer.
 *
 *  \param[in]      TimerConfig     Timer hardware configuration. Parameter must not be NULL.
 *
 ...
 *  \details        This function shall set the compare value of the given timer.
 *
 ...
 *  \details        The kernel uses this function to implement the FRT ISR. It is used to clear pending timer
 *                  interrupt flags, to be able to configure the next timer interrupt.
 *
 *  \param[in]      TimerConfig     Timer hardware configuration. Parameter must not be NULL.
 *
 *  \context        ISR2|OS_INTERNAL
