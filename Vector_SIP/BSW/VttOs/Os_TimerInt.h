...
/*! \brief Bit mask to access the upper bits of a timer value.
 *  \details This define is needed for calculation purpose, if the bit width of the hardware timer tick value is
 *           larger then the OS internal tick value bit width.
*/
# define OS_TIMERFRT_UPPERBITMASK    (OS_FRT_TICKTYPE_MAX - OS_OS_TICKTYPE_MAX)
 ...
 */
# define OS_TIMER_GETTICKTYPEQUARTER(Ticks)((Ticks) & OS_OS_TICKTYPE_QUARTER_MASK)                                      /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
Os_TimerIsFrtCorrectionNeeded,(void));
 ...
 **********************************************************************************************************************/
/*! \brief          Returns the upper part of a FrtTickType value.
 *  \details        --no details--
 *
 *  \param[in]      Value           The FrtTickType value.
 *
