...
#                            Gw_AsrPduR_Cfg5                                  #
# 1.00.00   2012-07-19  Lower   case module abbreviation
# 1.00.00   2012-07-23  Removed unneeded Dem_PBcfg.c
# 2.00.00   2013-10-04  mhe     Added reintroduced Dem_PBcfg.c
...
Dem_FILES                = Dem$(BSW_SRC_DIR)\Dem.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Dem$(BSW_SRC_DIR)\Dem.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
