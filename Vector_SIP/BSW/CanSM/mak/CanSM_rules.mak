...
#------------------------------------------------------------------------------
# 1.00.00   2011-03-13  MFi     Initial Version
# 1.01.00   2013-05-02  MFi     remove CanSM_PBCfg.c
...
CanSM_FILES              = CanSM$(BSW_SRC_DIR)\CanSM.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += CanSM$(BSW_SRC_DIR)\CanSM.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
