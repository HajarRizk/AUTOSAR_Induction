...
#  if ((COMM_SYNCHRONOUS_WAKE_UP == STD_ON) || (COMM_WAKEUPENABLEDOFPNC == STD_ON))
...
COMM_LOCAL_INLINE FUNC(void, COMM_CODE) ComM_PncSetBitInSignal(ComM_SizeOfPncSignalType InternalSignalId, ComM_PncIterType InternalPncId)
{
  ...
  ComM_PncSignalValuesType signalByte = (ComM_PncSignalValuesType)(ComM_GetPncSignalValues(signalByteIndex) | ComM_GetSetMaskOfPnc(InternalPncId)); /* PRQA S 2842 */ /* MD_ComM_2842 */
...
COMM_LOCAL_INLINE FUNC(void, COMM_CODE) ComM_PncClearBitInSignal(ComM_SizeOfPncSignalType InternalSignalId, ComM_PncIterType InternalPncId)
{
  ...
  ComM_SizeOfPncSignalValuesType signalByteIndex = (ComM_SizeOfPncSignalValuesType)(ComM_GetPncSignalValuesStartIdxOfPncSignal(InternalSignalId) + ComM_GetSignalByteIndexOfPncPb(InternalPncId)); /* PRQA S 2985 */ /* MD_ComM_2985 */
  ComM_PncSignalValuesType signalByte = (ComM_PncSignalValuesType)(ComM_GetPncSignalValues(signalByteIndex) & ComM_GetClearMaskOfPnc(InternalPncId)); /* PRQA S 2842 */ /* MD_ComM_2842 */
...
COMM_LOCAL_INLINE FUNC( boolean, COMM_CODE) ComM_PncIsEraReceivedOnActiveChannel( ComM_PncIterType pncIndex )
{
       ...
       pncSignalIndIter++)
  {
    ...
    {
      if ((ComM_GetGwTypeOfChannel(ComM_GetChannelIdxOfPncSignal(pncSignalInd)) == COMM_GATEWAY_TYPE_ACTIVE) && (ComM_IsSignalStoredPncBitSet(pncSignalInd, pncIndex))) /* PRQA S 2985 */ /* MD_ComM_2985 */ /* COV_COMM_PNC_EXTENDED_NO_ERA_ON_ACTIVE_CHANNEL */
      {
        retValue = TRUE;
        break;
      }
...
# if (COMM_PNC_PS_TIMER > 0U)
    else if ((ComM_GetPncPSleepTimer(pncIndex) > 0u) && (lHighestRequest <= COMM_PNC_PREPARE_SLEEP)) /* COV_COMM_PNC_ON_CHANNELS_NM_PASSIVE */
    {
...
# if (COMM_PNC_SUPPORT)
  else if (ComM_GetSizeOfPnc() != ComM_GetSizeOfPncPb()) /* PRQA S 2742 */ /* MD_ComM_2742 */ /* COV_COMM_GENDATA_CHECK */ /*lint !e506 */
  {
    errorId = COMM_E_WRONG_GENERATED_DATA; /* PRQA S 2880 */ /* MD_MSR_Unreachable */
  }
# endif
  else
  {
    for (channelIndex = 0u; channelIndex < ComM_GetSizeOfChannel(); channelIndex++)
    {
      ...
      if (ComM_GetWakeupStateOfChannel(channelIndex) >= COMM_MAX_NUMBER_OF_STATES) /* COV_COMM_GENDATA_CHECK */ /* PRQA S 2742 */ /* MD_ComM_2742 */ /*lint !e506 */
      {
        errorId = COMM_E_WRONG_GENERATED_DATA; /* PRQA S 2880 */ /* MD_MSR_Unreachable */
        break;
      }
