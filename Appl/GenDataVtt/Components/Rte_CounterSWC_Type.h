 ...
 *          License:  CBD1800285
 *
 *      Description:  Application types header file for SW-C <CounterSWC>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_COUNTERSWC_TYPE_H
# define _RTE_COUNTERSWC_TYPE_H
