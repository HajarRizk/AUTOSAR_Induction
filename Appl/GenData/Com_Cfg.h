...
#define COM_MAX_RXDYNSIGNALLENGTH                                     4294967295u
...
#define COM_MAX_RXTPSDULENGTH                                         4294967295u
#define COM_MAX_RXTPWRITTENBYTESCOUNTER                               4294967295u
...
#define COM_MAX_TXDYNSIGNALLENGTH                                     4294967295u
...
#define COM_MAX_TXTMPTPPDULENGTH                                      4294967295u
#define COM_MAX_TXTPSDULENGTH                                         4294967295u
#define COM_MAX_TXTPWRITTENBYTESCOUNTER                               4294967295u
/** 
  \}
*/ 
...
#define COM_NO_TXSIGINFODYNSIGIDXOFTXTPINFO                           255u
/** 
  \}
*/ 
...
#define Com_IsTxSigInfoDynSigUsedOfTxTpInfo(Index)                    ((Com_GetTxTpInfoOfPCConfig()[(Index)].TxSigInfoDynSigUsedOfTxTpInfo) != FALSE)
...
#define Com_IsTriggeredOfTxSigInfo(Index)                             (((boolean)(Com_GetApplTypeOfTxSigInfo(Index) == COM_UINT8_DYN_APPLTYPEOFTXSIGINFO)) != FALSE)  /**< TRUE if signal or group signal has any 'TRIGGERED_*' transfer property. */
...
#define Com_GetDynamicInitialLengthOfTxTpInfo(Index)                  ((Com_DynamicInitialLengthOfTxTpInfoType)((((Com_DynamicInitialLengthOfTxTpInfoType)(Index)) + 1u)))
...
#define Com_IsTxBufferUsedOfTxTpInfo(Index)                           Com_IsTxSigInfoDynSigUsedOfTxTpInfo(Index)  /**< TRUE, if the 0:n relation has 1 relation pointing to Com_TxBuffer */
#define Com_GetTxSigInfoDynSigIdxOfTxTpInfo(Index)                    ((Com_TxSigInfoDynSigIdxOfTxTpInfoType)((((Com_TxSigInfoDynSigIdxOfTxTpInfoType)(Index)) + 3u)))  /**< the index of the 0:1 relation pointing to Com_TxSigInfo */
/** 
  \}
*/ 
...
typedef uint8 Com_TxSigInfoDynSigIdxOfTxTpInfoType;
...
{
  Com_TxSigInfoDynSigUsedOfTxTpInfoType TxSigInfoDynSigUsedOfTxTpInfo;  /**< TRUE, if the 0:1 relation has minimum 1 relation pointing to Com_TxSigInfo */
} Com_TxTpInfoType;
...
/** 
  ...
  \details
  Element                Description
  TxSigInfoDynSigUsed    TRUE, if the 0:1 relation has minimum 1 relation pointing to Com_TxSigInfo
*/ 
#define COM_START_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Com_TxTpInfoType, COM_CONST) Com_TxTpInfo[1];
#define COM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
