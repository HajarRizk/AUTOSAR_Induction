...
#define ECUM_ATOMIC_VARIABLE_ACCESS 16u /* /MICROSAR/EcuC/EcucGeneral/AtomicVariableAccess */
#endif
...
#define ECUM_APPLICATIONOFPARTITIONINIT                               STD_OFF  /**< Deactivateable: 'EcuM_PartitionInit.Application' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
#define ECUM_BSWMPARTITIONOFPARTITIONINIT                             STD_OFF  /**< Deactivateable: 'EcuM_PartitionInit.BswMPartition' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
#define ECUM_ECUMPARTITIONOFPARTITIONINIT                             STD_OFF  /**< Deactivateable: 'EcuM_PartitionInit.EcuMPartition' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
