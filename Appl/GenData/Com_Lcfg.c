...
CONST(Com_TxSigInfoType, COM_CONST) Com_TxSigInfo[4] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     3 */    32760u,      4095u,          4103u,               8u, COM_UINT8_DYN_APPLTYPEOFTXSIGINFO,          0u, COM_ARRAY_BASED_BUSACCOFTXSIGINFO,                     0u,           1u }   /* [/ActiveEcuC/Com/ComConfig/DiagResponse_ComSignal, /ActiveEcuC/Com/ComConfig/DiagResponse] */
};
#define COM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
CONST(Com_TxTpInfoType, COM_CONST) Com_TxTpInfo[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
    /* Index    TxSigInfoDynSigUsed        Referable Keys */
  { /*     0 */                TRUE }   /* [/ActiveEcuC/Com/ComConfig/DiagResponse] */
};
#define COM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
